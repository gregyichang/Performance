/* http://keith-wood.name/timeEntry.html
   ...
   GC: modified 9/20/2016, changed delete to clear out field position and values
*/
 ...
 $(selector).timeEntry('setTime', null) */
		...
		_doKeyDown: function(event) {
			...
			switch (event.keyCode) {
			    ...
			    case 46:
			        plugin._setValue(inst, '');
			        plugin._resetField(inst);    /**by gc:  reset field on delete */
	    ...
	    /**by gc:  reset field on delete */
		_resetField: function (inst) {
		    inst._field = 0;
