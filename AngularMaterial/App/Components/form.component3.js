(function (app) {
    ...
    app.component("formC3",
    {
        templateUrl: "App/Components/form.component3.html",
        bindings: { 
        },
        controller: ["$location", "$mdDialog", form3Controller],
        controllerAs: "$ctrl"
    });

    function form3Controller($location, $mdDialog) {
        var vm = this;
        vm.students = [];
        vm.showList1 = true;
