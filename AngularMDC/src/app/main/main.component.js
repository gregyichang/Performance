export default function(app) {
    app.component("main",
    {
        template: require("html-loader!./main.component.html"),
        bindings: { 
        },
        controller: ["$location", "$mdcDialog", MainController],
        controllerAs: "$ctrl"
    });

    function MainController($location, $mdcDialog) {
        var vm = this;
        vm.students = [];
        ...
        vm.viewDetails = function () {
            ...
            $mdcDialog.show({
                contentElement: '#mdc-dialog-with-list',
                parent: 'main',
